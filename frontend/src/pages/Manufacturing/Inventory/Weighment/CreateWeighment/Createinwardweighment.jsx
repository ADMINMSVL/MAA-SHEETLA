...
//   const [creating,  setCreating]  = useState(null); // ginNo being processed
...
//   /* ─── Click GIN No — check / create weighment ─── */
...
//       /* 2. Get doc-sequence number from backend */
//       const seqRes = await axios.get(`${WEIGHMENT_API}/next-no`, {
//         params: { transactionType: "Inward" },
//       });
//       const weighmentNo = seqRes.data?.weighmentNo || `IN${today.replace(/-/g, "").slice(2)}0001`;

//       /* 3. Create new weighment */
//       const payload = {
//         weighmentNo,
...
//         }
//         .ciw-search-btn {
//           padding: 7px 22px; background: #6366f1; color: #fff; border: none;
//           border-radius: 6px; font-size: 13px; font-weight: 700; cursor: pointer;
//         }
//         .ciw-search-btn:hover:not(:disabled) { background: #4f46e5; }
...
//         .ciw-table thead { background: #f8fafc; }
//         .ciw-table th {
//           padding: 9px 10px; text-align: left; font-size: 11px;
//           font-weight: 700; color: #374151; border-bottom: 1.5px solid #e5e7eb;
//         }
//         .ciw-table td {
//           padding: 7px 10px; border-bottom: 1px solid #f1f5f9; color: #374151;
//         }
//         .ciw-table tbody tr:hover { background: #f8fafc; }
...
//         }
//         .ciw-gin-no-link:hover { color: #4f46e5; }
